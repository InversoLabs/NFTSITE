...
import "https://github.com/InversoLabs/NFTSITE/blob/main/CRUXRewards.sol";
import "https://github.com/InversoLabs/NFTSITE/blob/main/Collection.sol";
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(Collection _nft, CRUXRewards _token) { 
    nft = _nft;
    token = _token;
  }
